...
* **Graphics File Devices**
  * _**Vector Formats**_ \(good for line drawings/plots w/ solid colors, a modest number of points\)
  ...
  * _**Bitmap Formats**_ \(good for plots w/ large number of points, natural scenes/webbased plots\)
